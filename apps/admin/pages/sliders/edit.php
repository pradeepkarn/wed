<?php
$slider_detail = $context->slider_detail;
$pd = obj($slider_detail);
...
<form action="/<?php echo home . route('sliderUpdateAjax', ['id' => $pd->id]); ?>" id="update-new-page-form">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col">
                ...
                <div class="col text-end my-3">
                    <a class="btn btn-dark" href="/<?php echo home . route('sliderList'); ?>">Back</a>
                </div>
            </div>
            <div id="res"></div>
            <div class="row">
