                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col my-3">
                            ...
                            <nav class="nav">
                                <a class="nav-link <?php echo $active ? "btn btn-sm btn-primary text-white" : ""; ?>" href="/<?php echo home . route('sliderList'); ?>">Active List</a>
                                <a class="nav-link <?php echo $active ? "" : "btn btn-sm btn-danger text-white"; ?>" href="/<?php echo home . route('sliderTrashList'); ?>">Trash List</a>
                            </nav>
                        ...
                        <div class="col text-end my-3">
                            <a class="btn btn-dark" href="/<?php echo home . route('sliderCreate'); ?>">Add New</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($pl as $key => $pv) :
                                ...
                                if ($pv->is_active == true) {
                                    $move_to_text = "Trash";
                                    $move_to_link = route('sliderTrash', ['id' => $pv->id]);
                                } else {
                                    $move_to_link = route('sliderDelete', ['id' => $pv->id]);
                                    $move_to_text = "Delete";
                                    $restore_text = "Restore";
                                    $restore_link = route('sliderRestore', ['id' => $pv->id]);
                                }
                            ?>
                                ...
                                <tr>
                                    ...
                                    if ($active == true) { ?>
                                        <td>
                                            <a class="btn-primary btn btn-sm" href="/<?php echo home . route('sliderEdit', ['id' => $pv->id]); ?>">Edit</a>
                                        </td>
                                    <?php    }
                                    ?>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            if ($active == true) {
                                $link =  route('sliderList');
                            } else {
                                $link =  route('sliderTrashList');
                            }
        ...
        for (const tp of trendingPost) {
            tp.addEventListener('click', () => {
                ...
                sendData({
                    ...
                    `/<?php echo home . route('sliderToggleMarked') ?>`,
                    (err, response) => {
                        if (err) {
