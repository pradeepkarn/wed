<form action="/<?php echo home . route('search'); ?>" method="get">
    ...
    <div class="row">
        <div class="text-center col text-white my-2 d-grid">
            <button type="submit" <?php if (!authenticate()) : ?> onclick="openFacebookLoginPopup()" <?php endif; ?> class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <?php if (authenticate()) : ?>
                    <span>Search</span>
