                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col my-3">
                            ...
                            <nav class="nav">
                                <a class="nav-link <?php echo $active ? "btn btn-sm btn-primary text-white" : ""; ?>" href="/<?php echo home . route('pageList'); ?>">Active List</a>
                                <a class="nav-link <?php echo $active ? "" : "btn btn-sm btn-danger text-white"; ?>" href="/<?php echo home . route('pageTrashList'); ?>">Trash List</a>
                            </nav>
                        ...
                        <tbody>
                            <?php foreach ($pl as $key => $pv) :
                                ...
                                if ($pv->is_active == true) {
                                    $move_to_text = "Trash";
                                    $move_to_link = route('pageTrash', ['id' => $pv->id]);
                                } else {
                                    $move_to_link = route('pageDelete', ['id' => $pv->id]);
                                    $move_to_text = "Delete";
                                    $restore_text = "Restore";
                                    $restore_link = route('pageRestore', ['id' => $pv->id]);
                                }
                            ?>
                                ...
                                <tr>
                                    ...
                                    if ($active == true) { ?>
                                        <td>
                                            <a class="btn-primary btn btn-sm" href="/<?php echo home . route('pageEdit', ['id' => $pv->id]); ?>">Edit</a>
                                        </td>
                                    <?php    }
                                    ?>
        ...
        for (const tp of trendingPost) {
            tp.addEventListener('click', () => {
                ...
                sendData({
                    ...
                    `/<?php echo home . route('pageToggleMarked') ?>`,
                    (err, response) => {
                        if (err) {
